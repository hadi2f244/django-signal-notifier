...
from django_signal_notifier.messengers import messenger_names
...
class TriggerTestCase(SignalNotifierTestBase):
	...
	def test_register_trigger_templates(self):
		...
		backend1 = Backend.objects.create(name="BaseMessenger", message_template="BaseMessageTemplate")
		backend2 = Backend.objects.create(name="TelegramBotMessenger", message_template="SimpleTelegramMessageTemplate1")
		backend3 = Backend.objects.create(name="SMTPEmailMessenger", message_template = "SimpleEmailMessageTemplate")
		backend4 = Backend.objects.create(name="TelegramBotMessenger", message_template="SimpleTelegramMessageTemplate2")
	...
	def test_register_trigger_by_custom_signal(self):
		...
		# Create a backend
		simple_backend = Backend.objects.filter(name=messenger_names[0][0])[0]
