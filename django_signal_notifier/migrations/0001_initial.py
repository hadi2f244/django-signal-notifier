    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('SimplePrintMessagner1', 'SimplePrintMessagner1'), ('SimplePrintMessagner2', 'SimplePrintMessagner2')], default='BaseMessanger', max_length=128, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='TestModel',
