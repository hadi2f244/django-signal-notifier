    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('SimplePrintMessenger1', 'SimplePrintMessenger1'), ('SimplePrintMessenger2', 'SimplePrintMessenger2')], default='BaseMessanger', max_length=128, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='TestModel',
